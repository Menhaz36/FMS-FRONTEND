...
const Final = () => {
    ...
    //here as we are using fetch we also need to add authheader for middleware authentication
    // useEffect(() => {
    ...
    //             });
    //             console.log("booking api call",response);
  ...
  if (bookingData) storeBookingData();
}, [bookingData]);
